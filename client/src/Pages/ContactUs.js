...
function ContactUs() {
  return (
    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <div>
            <ul className='social'>
              <li>
                <a href='https://www.linkedin.com/in/samuel-levy-software/' className='link' target="_blank"><FaLinkedinIn></FaLinkedinIn></a>
              </li>
              <li>
                <a href='https://github.com/samlevy25' className='link' target="_blank"><FaGithub></FaGithub></a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="i-right">
        <div className="i-bg"></div>
        <img src={img3} alt="" className="i-img" />
      </div>
    </div>
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <div>
            <ul className='social'>
              <li>
                <a href='https://www.linkedin.com/in/adaneadgo/' className='link' target="_blank"><FaLinkedinIn></FaLinkedinIn></a>
              </li>
              <li>
                <a href='https://github.com/Adaneadgo' className='link' target="_blank"><FaGithub></FaGithub></a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="i-right">
        <div className="i-bg"></div>
        <img src={img4} alt="" className="i-img" />
      </div>
    </div>
    </>
  );
